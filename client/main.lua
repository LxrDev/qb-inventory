...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    if not IsEntityDead(PlayerPedId()) then
        QBCore.Functions.Progressbar("open_inventory", "Just A Moment..", 100, false, false, {
...
RegisterNetEvent('inventory:client:UseWeapon', function(weaponData, shootbool)
    ...
    if currentWeapon == weaponName then
        ...
        currentWeapon = nil
    elseif weaponName == "weapon_stickybomb" or weaponName == "weapon_pipebomb" or weaponName == "weapon_smokegrenade" or weaponName == "weapon_flare" or weaponName == "weapon_proxmine" or weaponName == "weapon_ball"  or weaponName == "weapon_molotov" or weaponName == "weapon_grenade" or weaponName == "weapon_bzgas" or weaponName == "weapon_shoe" or weaponName == "weapon_brick" or weaponName == "weapon_book" or weaponName == "weapon_cash" then
